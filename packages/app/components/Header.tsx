    ...
    <div className="h-16 flex justify-end bg-[#4586f0] dark:bg-gray-800 grow-0 shrink-0">
      ...
      <label className="relative inline-flex cursor-pointer select-none items-center">
        <input
          ...
          className="sr-only"
        />
        <div className="shadow-card flex h-[40px] w-[40px] items-center justify-center rounded-lg bg-white relative mr-4">
          <span
            className={`flex h-9 w-9 items-center justify-center rounded absolute ${
              isChecked ? "bg-primary text-white opacity-0" : "text-body-color"
            }`}
          >
            <svg
              width="16"
